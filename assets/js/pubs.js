...
(function () {
  ...
  /* ---------- last-saved fallback list (refreshed from ORCID, 17 Sep 2026) ---------- */
  var FALLBACK_WORKS = [
    ...
    { title: "Flexible and printable thermoelectric films based on FeCl3 doped P3HT", year: "2026", journal: "Scientific Reports", doi: "10.1038/s41598-025-22821-6" },
    { title: "Effect of CuS on self-powered photodetective properties of flexible ZnO-P3HT heterojunction device", year: "2026", journal: "Materials Science and Engineering: B", doi: "10.1016/j.mseb.2025.119146" },
    { title: "PVDF/Ni NWs Composite Films: A High‐Performance N‐Type Thermoelectric Material for Flexible Energy Harvesting", year: "2025", journal: "Polymer Composites", doi: "10.1002/pc.70640" },
    ...
    { title: "Ion-induced transformation of shallow defects into deep-level defects in GaN epilayers", year: "2024", journal: "Nuclear Instruments and Methods in Physics Research Section B: Beam Interactions with Materials and Atoms", doi: "10.1016/j.nimb.2024.165362" },
    ...
    { title: "Disorder induced in GaN thin films by 200 MeV silver ions", year: "2024", journal: "Nuclear Instruments and Methods in Physics Research Section B: Beam Interactions with Materials and Atoms", doi: "10.1016/j.nimb.2024.165346" },
    ...
    { title: "Enhancement in thermoelectric properties of n-type (La0.7Sr0.3MnO3)0.5.(NiO)0.5: composite and nano-structure effect", year: "2022", journal: "Journal of Physics D: Applied Physics", doi: "10.1088/1361-6463/ac3171" },
    ...
    { title: "Understanding the role of structural distortions on the transport properties of Ar ion irradiated SrTiO3 thin films: X-ray absorption investigation", year: "2021", journal: "Journal of Applied Physics", doi: "10.1063/5.0067510" },
    ...
    { title: "Electronic Structure and Thermoelectric Properties of Co2CrGa Using First Principles Calculations", year: "2019", journal: "AIP Conference Proceedings", doi: "10.1063/1.5113207" },
    ...
    { title: "In-situ transport and microstructural evolution in GaN Schottky diodes and epilayers exposed to swift heavy ion irradiation", year: "2018", journal: "Journal of Applied Physics", doi: "10.1063/1.4995491" },
    ...
    { title: "Structural, optical and magnetic properties of N ion implanted CeO2 thin films", year: "2017", journal: "RSC Advances", doi: "10.1039/C6RA17069B" },
    { title: "Nano-pits on GaAs (100) surface: Preferential sputtering and diffusion", year: "2016", journal: "Nuclear Instruments and Methods in Physics Research Section B: Beam Interactions with Materials and Atoms", doi: "10.1016/J.NIMB.2016.03.053" },
    { title: "Structural and Dielectric Properties of Cu doped CeO<sub>2</sub>", year: "2016", journal: "AIP Conference Proceedings", doi: "10.1063/1.4946350" },
    { title: "Structural, electrical and magnetic properties of dilutely Y doped NiFe2O4 nanoparticles", year: "2016", journal: "Journal of Alloys and Compounds", doi: "10.1016/J.JALLCOM.2016.05.248" },
    ...
    { title: "Structural, morphological, electrical and dielectric properties of Mn doped CeO2", year: "2016", journal: "Journal of Alloys and Compounds", doi: "10.1016/J.JALLCOM.2016.02.153" },
    ...
    { title: "Dynamics of modification of Ni/n-GaN Schottky barrier diodes irradiated at low temperature by 200 MeV Ag14+ ions", year: "2014", journal: "Applied Physics Letters", doi: "10.1063/1.4862471" },
    ...
    { title: "XPS study of triangular GaN nano/micro-needles grown by MOCVD technique", year: "2014", journal: "Materials Science and Engineering B", doi: "10.1016/J.MSEB.2014.03.010" },
    ...
    { title: "Electrical and microstructural analyses of 200 MeV Ag14+ ion irradiated Ni/GaN Schottky barrier diode", year: "2012", journal: "Applied Physics Letters", doi: "10.1063/1.4758929" },
    ...
    { title: "Defect Formation in GaN Epitaxial Layers due to SHI Irradiation", year: "2011", journal: "AIP Conference Proceedings", doi: "10.1063/1.3606246" },
